...
// 需發佈前，檔案的task流程
gulp.task('build', gulpSequence('clean', 'jade', 'map', 'file', 'copyFonts', 'sass', 'babel', 'vendorJs', 'copyHTML', 'image-min'));

// 開發時，gulp的流程
gulp.task('default', ['jade', 'map', 'file', 'copyFonts', 'sass', 'babel', 'vendorJs', 'copyHTML', 'image-min', 'browser-sync', 'watch']);
